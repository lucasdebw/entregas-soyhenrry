...
function crearClaseEmprendedor() {
  class Emprendedor {
      constructor(nombre, apellido, libros, mascotas) {
          ...
          // Tu código aca: constructor (nombre= lucas, aperrlido= tello, libros=, mascotas= perro)
      ...
      addBook(book, autor) {
          ...
          // Tu código aca: addBook(Introducción a la Programación con Python, luis eduardo muñoz guerrero/omar ivan trejos buritica)
      ...
      getBooks() {
          ...
          // Tu código aca:getBooks(Introducción a la Programación con Python, luis eduardo muñoz guerrero/omar ivan trejos buritica)
      ...
      getFullName() {
          ...
          // Tu código aca:getFullName(Lucas Sebastian Tello)
